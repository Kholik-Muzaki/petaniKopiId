                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative w-full">
                        ...
                        >
                            {produkRekomendasi.map((produk, index) => (
                                <SwiperSlide key={index}>
                                    <div
                                        className="w-full h-full bg-cover bg-center flex flex-col justify-end p-6 text-white rounded-lg shadow-lg hover:scale-105 transition-all duration-500 ease-in-out"
                                        style={{
                        ...
                        <div className="absolute top-1/2 left-0 transform -translate-y-1/2 z-10">
                            <button className="swiper-button-prev p-3 rounded-full bg-white shadow-lg hover:bg-green-500 transition">
                                <FaArrowLeft className="text-gray-600 text-lg" />
                            </button>
                        </div>
                        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 z-10">
                            <button className="swiper-button-next p-3 rounded-full bg-white shadow-lg hover:bg-green-500 transition">
